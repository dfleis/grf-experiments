...
path <- "data/bench-tree-1-3/"
basename_pattern <- "bench-tree-1-3-.*.csv"
...
filename_plt <- sprintf("figures/tree/bench-tree-abs-%s-%s.pdf", MODEL_TYPE, SETTING_ID)
ggsave(filename_plt, plot = plt, width = 5, height = 5)
